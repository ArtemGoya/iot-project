...
def print_data_from_external_sensors(temp, hum, light, wind):
    # if simulated:
...
def print_data_from_internal_sensors(temp, hum, light):
    # if simulated:
...
def get_external_sensors_data() -> tuple[float, float, float, float]:
    ...
    if SIMULATION_MODE:
        ...
        if SIMULATION_DAY:
            ...
            print_data_from_external_sensors(
                SIMULATION_EXTERNAL_TEMPERATURE, SIMULATION_EXTERNAL_HUMIDITY, SIMULATION_EXTERNAL_LIGHTING, SIMULATION_EXTERNAL_WIND)
    ...
    if SIMULATION_MODE:
        ...
        if SIMULATION_DAY:
            ...
            print_data_from_internal_sensors(
                SIMULATION_EXTERNAL_TEMPERATURE, SIMULATION_EXTERNAL_HUMIDITY, SIMULATION_EXTERNAL_LIGHTING)
