...
def get_external_sensors_data() -> tuple[float, float, float, float]:
    ...
    if SIMULATION_MODE:
        ...
        if SIMULATION_DAY:
            ...
            SIMULATION_EXTERNAL_LIGHTING -= SIMULATION_EXTERNAL_LIGHTING_CHANGE
            SIMULATION_EXTERNAL_WIND -= SIMULATION_EXTERNAL_WIND_CHANGE
        print_data_from_external_sensors(SIMULATION_EXTERNAL_TEMPERATURE, SIMULATION_EXTERNAL_HUMIDITY, SIMULATION_EXTERNAL_LIGHTING, SIMULATION_EXTERNAL_WIND, True)
