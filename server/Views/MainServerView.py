...
class MainServerView(Frame):
    ...
    def createLeftFrame(self):
        ...
        detectorsData2.create_window((0, 0),width=800, window=detectorsData, anchor="nw")
        
        for i in range(10) :
            self.add_client_frame(detectorsData);
    ...
    def add_client_frame(self,frame):
        ...
        idValLabel = Label(clientFrame,  height=2,
                             text="254657", font=("Helvetica", 19), bg="#fff")
    ...
    def show_details(self):
        ...
        detail_frame = Frame(top, height=800,width=1330, background=self.color)
        ...
        details_table = ttk.Treeview(detail_frame, yscrollcommand=detail_scroll.set, height=800)
        style = ttk.Style()
        ...
        details_table['columns'] = ('tmp_in', 'hum_in', 'light_in', 'tmp_out', 'hum_out', "light_out", "wind", "windows","lighting","time")
        ...
        details_table.heading("light_in",text="Jasnosć wewn. [lux]",anchor=CENTER)
        details_table.heading("tmp_out",text="Temp. zewn. [*C]",anchor=CENTER)
        details_table.heading("hum_out",text="Wilg. zwen. [%]",anchor=CENTER)
        details_table.heading("light_out",text="Jasnosć zewn. [lux]",anchor=CENTER)
        details_table.heading("wind",text="Wiatr [m/s]",anchor=CENTER)
        details_table.heading("windows",text="Stan okiennic",anchor=CENTER)
        details_table.heading("lighting",text="Stan oświetlenia",anchor=CENTER)
